...
\usepackage{etoolbox}
\usepackage{tikz}	\usetikzlibrary{calc,arrows,decorations.pathmorphing,backgrounds,positioning,fit,shapes,decorations.shapes, shapes.geometric, decorations.pathreplacing, decorations.text,shadows}
 
	\tikzstyle{block} = [draw,rectangle,thick,minimum height=2em,minimum width=2em,fill=blue!50]
