...
impl PriceAnalyzer {
    ...
    fn extract_twap_info(&self, tx: &CheckpointTransaction) -> Option<TWAPInfo> {
    ...
    fn extract_swap_impacts(&self, tx: &CheckpointTransaction) -> Vec<SwapImpact> {
    ...
    fn has_deviation_detected_event(&self, tx: &CheckpointTransaction) -> bool {
